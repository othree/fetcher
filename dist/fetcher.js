...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(mod.exports, mod, global._param);
  ...
  var _param2 = _interopRequireDefault(_jqueryParam);
  ...
  var Fetcher = (function () {
    ...
    _createClass(Fetcher, [{
      ...
      key: 'options',
      value: function options(url, data, _options) {
        return this.request('OPTIONS', url, data, _options);
      }
    }, {
      key: 'post',
